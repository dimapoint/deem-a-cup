...
interface AddToListButtonProps {
	cafeId: string
	userLists: ListWithCount[] // Pass lists to avoid fetching in client component if possible, or fetch inside
}
		...
		<div className="relative">
			...
			{isOpen && (
				<>
					...
					/>
					<div className="absolute right-0 top-full z-50 mt-2 w-72 rounded-lg border border-gray-700 bg-[#1e232b] p-4 shadow-xl">
